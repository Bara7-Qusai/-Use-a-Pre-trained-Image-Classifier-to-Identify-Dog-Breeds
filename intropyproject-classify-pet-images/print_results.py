...
#                                                                             
# PROGRAMMER: Barah Qusai
# DATE CREATED: 1-7-2024
# REVISED DATE: 
...
def print_results(results_dic, results_stats_dic, model, 
    ...
    # Print the total number of images, number of dog images, and number of "Not-a" dog images
    ...
    # Print incorrect classifications of breeds (if requested)
